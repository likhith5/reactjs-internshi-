  ...
  async function generateAnswer(e) {
    ...
    try {
      const response = await axios({
        ...
        method: 'post',
        headers: {
          'x-rapidapi-key': process.env.VITE_API_GENERATIVE_LANGUAGE_CLIENT,
      ...
      setChatHistory((prev) => [
        ...prev,
        { type: 'answer', content: "Sorry, I couldn't fetch a response." },
      ]);
    } finally {
    ...
    <div className="fixed inset-0 bg-gradient-to-r from-blue-50 to-blue-100">
      <div className="h-full max-w-4xl mx-auto flex flex-col p-3">
        <header className="text-center py-4">
          <a href="https://github.com/likhith5/ai-chatbot.git" 
             target="_blank" 
            ...
            <div className="h-full flex flex-col items-center justify-center text-center p-6">
              <div className="bg-blue-50 rounded-xl p-8 max-w-2xl">
                ...
                <p className="text-gray-500 mt-6 text-sm">
                  It’s important to send your questions correctly!
                </p>
